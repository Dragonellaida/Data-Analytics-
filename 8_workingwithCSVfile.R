...
data1 <- read_csv('C:/Users/ADMIN/Desktop/DATA ANALYTICS/ENGINEERING DATA ANALYSIS/StudentsPerformance.csv',show_col_types = FALSE)
head(data1, 5)
#to view data in a different tab
View(data1)

#read.table() can be used to load data in a table
data2 <- read.table('C:/Users/ADMIN/Desktop/DATA ANALYTICS/ENGINEERING DATA ANALYSIS/StudentsPerformance.csv', sep=",", header = 1)
head(data2, 5)
